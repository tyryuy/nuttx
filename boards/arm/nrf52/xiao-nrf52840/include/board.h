/****************************************************************************
 * boards/arm/nrf52/xiao-nrf52840/include/board.h
 *
...
#ifndef __BOARDS_ARM_NRF52_XIAO_NRF52840_INCLUDE_BOARD_H
#define __BOARDS_ARM_NRF52_XIAO_NRF52840_INCLUDE_BOARD_H
...
#define BOARD_UART0_RX_PIN  (GPIO_INPUT  | GPIO_PORT1 | GPIO_PIN(12))
#define BOARD_UART0_TX_PIN  (GPIO_OUTPUT | GPIO_VALUE_ONE | GPIO_PORT1 | GPIO_PIN(11))

/* I2C0: XIAO nRF52840 Sense onboard LSM6DS3TR-C */

#define BOARD_I2C0_SDA_PIN  (GPIO_INPUT  | GPIO_PORT0 | GPIO_PIN(7))
#define BOARD_I2C0_SCL_PIN  (GPIO_OUTPUT | GPIO_PORT0 | GPIO_PIN(27))

/* I2C1: XIAO D4/D5 external pins */

#define BOARD_I2C1_SDA_PIN  (GPIO_INPUT  | GPIO_PORT0 | GPIO_PIN(4))
#define BOARD_I2C1_SCL_PIN  (GPIO_OUTPUT | GPIO_PORT0 | GPIO_PIN(5))

/* XIAO nRF52840 Sense IMU */
#define BOARD_IMU_PWR_PIN   (GPIO_OUTPUT | GPIO_VALUE_ONE | GPIO_DRIVE_S0H1 | \
                             GPIO_PORT1 | GPIO_PIN(8))
#define BOARD_IMU_INT1_PIN  (GPIO_INPUT  | GPIO_PORT0 | GPIO_PIN(11))

#endif /* __BOARDS_ARM_NRF52_XIAO_NRF52840_INCLUDE_BOARD_H */
